...
\newcommand{\versuchsnummer}{Versuch 3}
\newcommand{\versuchstitel}{Asynchronmaschine mit Schleifringläufer}
...
\newcommand{\vornameStudZwei}{Nils}
\newcommand{\nachnameStudZwei}{Völker}
\newcommand{\matrikelnummerStudZwei}{7023637}
